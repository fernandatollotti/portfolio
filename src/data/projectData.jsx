export const projectData = [
  {
    ...
    clientName: "Macena Silva",
    estimatedTime: "1 mês",
    category: "Site Institucional",
    tools: ["Wordpress", "Elementor", "CSS", "PHP"],
    links: [
      { label: "Ver Projeto", url: "https://macenasilva.com.br" }
    ]
  },
  {
    key: "tempervale",
    ...
    clientName : "Tempervale",
    estimatedTime: "1 mês",
    category: "Site Institucional",
    tools: ["Wordpress", "Elementor"],
    links: [
      { label: "Ver Projeto", url: "https://tempervale.com" }
    ]
  },
  {
    key: "grupo-effetto",
    ...
    clientName : "Grupo Effetto",
    estimatedTime: "1 mês",
    category: "Site Institucional",
    tools: ["Wordpress", "Elementor"],
    links: [
      { label: "Ver Projeto", url: "https://effetto.com.br/" }
    ]
  },
  {
    ...
    nameClient: "Projeto Pessoal",
    estimatedTime: "2 dias",
    tools: ["HTML", "CSS", "JavaScript"],
    links: [
      { label: "Ver Projeto", url: "https://landing-page-stranger-things.netlify.app" },
      { label: "Acessar GitHub", url: "https://github.com/fernandatollotti/landing-page-stranger-things" }
    ]
  },
  {
    key: "optimus-tech",
    ...
    tools: ["HTML", "CSS", "JavaScript"],
    links: [
      { label: "Ver Projeto", url: "https://optimus-tech-website.netlify.app" },
      { label: "Acessar GitHub", url: "https://github.com/fernandatollotti/optimus-tech" }
    ]
  }
]